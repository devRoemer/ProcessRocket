...
export default class HelloWorld extends Vue {
    mounted(): void {
        ...
        ipcRenderer.send(
            IpcEventNames.TERMINAL_CREATE,
            terminalCreateEventData
        );
        ...
        ipcRenderer.on(
            ...
            (_: IpcRendererEvent, eventData: ITerminalEventData) => {
                if (eventData.identifier === terminalIdentifier)
                    terminalUi.write(eventData.payload);
            }
        );
